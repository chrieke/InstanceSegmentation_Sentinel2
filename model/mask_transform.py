...
def mask_aggregation(boxes, masks, mask_weights, im_width, im_height, binary_thresh=0.4):   #bei gpu mask voting!
    """
...
def gpu_mask_voting(masks, boxes, scores, num_classes, max_per_image, im_width, im_height,
                    nms_thresh, merge_thresh, binary_thresh=0.4, device_id=0):  #0.4
    """
